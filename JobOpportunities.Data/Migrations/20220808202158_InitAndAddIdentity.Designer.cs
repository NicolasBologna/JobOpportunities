...
namespace JobOpportunities.Data.Migrations
{
    ...
    [Migration("20220808202158_InitAndAddIdentity")]
    partial class InitAndAddIdentity
    {
            ...
            modelBuilder.Entity("JobOpportunities.Domain.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 8, 8, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7611),
            ...
            modelBuilder.Entity("JobOpportunities.Domain.JobOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 8, 8, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7625),
                            Description = "Una posición para pasarla bien",
                            Title = ".NET FullStack FullTime",
                            ValidUntil = new DateTime(2022, 11, 6, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7627)
                        });
                });
            ...
            modelBuilder.Entity("JobOpportunities.Domain.Knowledge", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 8, 8, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7555),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 8, 8, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7565),
            ...
            modelBuilder.Entity("JobOpportunities.Domain.Skill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 8, 8, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7586),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 8, 8, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7596),
            ...
            modelBuilder.Entity("JobOpportunities.Domain.SkillLevel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 8, 8, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7514),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 8, 8, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7535),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 8, 8, 17, 21, 57, 706, DateTimeKind.Local).AddTicks(7543),
            ...
            modelBuilder.Entity("JobOpportunities.Domain.Candidate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "66f946b4-b63f-4f38-9514-ef3384f7683f",
                            ...
                            SecurityStamp = "e3f89708-86e5-42f0-bf3b-34e5bb42b940",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "89fd39fd-e04e-46cf-90aa-bb48a2513d46",
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0483801c-6bf9-4129-bab9-4e56a0fc6b2d",
                            TwoFactorEnabled = false,
